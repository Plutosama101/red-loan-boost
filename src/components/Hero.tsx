        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-center md:justify-start space-x-2">
                  ...
                  <span className="text-sm md:text-base font-medium">Instant Approval</span>
                </div>
                <div className="flex items-center justify-center md:justify-start space-x-2">
                  <Clock className="h-5 w-5 text-primary" />
                  <span className="text-sm md:text-base font-medium">5-Minute Process</span>
                </div>
                <div className="flex items-center justify-center md:justify-start space-x-2">
                  <Shield className="h-5 w-5 text-primary" />
                  <span className="text-sm md:text-base font-medium">Secure & Safe</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4 pt-6">
                ...
                <div className="text-center md:text-left">
                  <div className="text-xl md:text-2xl font-bold text-primary">₦2B+</div>
                  <div className="text-xs md:text-sm text-muted-foreground">Loans Disbursed</div>
                </div>
                <div className="text-center md:text-left">
          ...
          <div className="relative flex justify-center order-1 md:order-2">
            <div className="relative">
              {/* Phone Frame */}
              <div className="w-56 md:w-64 h-[460px] md:h-[520px] bg-loan-secondary rounded-[2.5rem] p-2 shadow-loan-card">
